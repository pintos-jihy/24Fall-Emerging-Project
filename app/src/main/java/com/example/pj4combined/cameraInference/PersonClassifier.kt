...
class PersonClassifier {
    ...
    fun initialize(context: Context, threadNumber: Int = 1, useGPU: Boolean = true) {
        setupObjectDetector(context, threadNumber, useGPU)
    }
    ...
    private fun setupObjectDetector(context: Context, threadNumber: Int, useGPU: Boolean) {
        ...
        val baseOptionsBuilder = BaseOptions.builder().setNumThreads(threadNumber)
    ...
    companion object {
        ...
        const val MODEL_NAME = "efficientdet_1.tflite"
    }
}
